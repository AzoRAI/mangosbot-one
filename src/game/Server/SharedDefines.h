...
enum SpellAttributesEx6
{
    ...
    SPELL_ATTR_EX6_UNK29                       = 0x20000000,// 29 do not apply damage mods (usually in cases where it has already been applied)
...
enum ArenaType
{
	...
	ARENA_TYPE_1v1			= 1, //Custom 1v1 Rated Arena
    ARENA_TYPE_2v2          = 2,
    ARENA_TYPE_3v3          = 3,
    ARENA_TYPE_5v5          = 5
};
...
#define EXPECTED_MANGOSD_CLIENT_VERSION      "2.4.3"
